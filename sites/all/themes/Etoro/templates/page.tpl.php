...
<div id="mobile-menu"> <a class="reorder" href="#"><i class="icon-reorder"></i></a> | <a href="/user"><i class="icon-user"></i></a> | <?php echo $language->language=='en'?'<a class="zh-lan" href="/zh-hans">中文</a>':'<a class="en-lan" href="/en">EN</a>'; ?> </div>

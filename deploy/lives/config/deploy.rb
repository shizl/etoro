...
set :repository,  "http://steve:mrshen890122@git.yeaoh.net/team-a/etoro.git"
# Or: `accurev`, `bzr`, `cvs`, `darcs`, `subversion`, `mercurial`, `perforce`, `subversion` or `none`


set  :keep_releases,  2
set :app_symlinks, ["/sites/default" , "/tmp"]
#set :app_shared_dirs, ["/etoro/sites/default"]
set :app_shared_files, ["/.htaccess"]
...
after   'drupal:settings_update', 'deploy:cleanup'
